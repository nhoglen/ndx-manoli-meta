...
# Next Steps for ndx-manoli-meta Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-manoli-meta directory: `cd ndx-manoli-meta`
...
`spec/ndx-manoli-meta.namespace.yaml` and
`spec/ndx-manoli-meta.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-manoli-meta
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/nhoglen/ndx-manoli-meta/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-manoli-meta/0.1.0
...
`staged-extensions/ndx-manoli-meta`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-manoli-meta
    ```

13. Edit `staged-extensions/ndx-manoli-meta/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/nhoglen/ndx-manoli-meta
      pip: https://pypi.org/project/ndx-manoli-meta/
      license: BSD-3
      maintainers: 
        - nhoglen
      ```

14. Edit `staged-extensions/ndx-manoli-meta/README.md`
to add information about your extension. You may copy it from
`ndx-manoli-meta/README.md`.

  ```bash
  cp ndx-manoli-meta/README.md staged-extensions/ndx-manoli-meta/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-manoli-meta
git commit -m "Add new catalog entry for ndx-manoli-meta" .
git push
```
...
ndx-manoli-meta-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-manoli-meta GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-manoli-meta-record repository on GitHub.
